...
| `boot.mjs` (490) | Açılışta konsol hatası, WT-01 saat dilimi, WT-02 sayı biçimi, WT-04 sınırlar, tüm sekmelerin çizimi, WT-80 geniş ekran, WT-81/4-5 ölü anahtar/CSS taraması, WT-81/7 kur çekmede yedek kaynak |
...
| `homework.mjs` (28) | WT-16 Ev-İş/Firma ayrımı, şema v3 migration'ı (v2 verisiyle ayrı açılış), kWh birim fiyatından tutar, dil değişimi regresyonu |
...
| `kwh.mjs` (10) | WT-81/8 taze kurulumda ev elektrik fiyatı. **Onboarding'i ATLAMAYAN tek koşum** — kusur yalnız orada görünüyordu |
